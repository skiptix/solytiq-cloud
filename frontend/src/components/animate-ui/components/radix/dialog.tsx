...
// "components-radix-dialog" — same upstream reference/license/patch note as
// primitives/radix/dialog.tsx (see that file). LOCAL PATCH: removed an
// unused `import * as React from 'react'` present in the upstream file — it
// fails this project's `noUnusedLocals: true` (pre-existing, not added for
// Animate UI).
