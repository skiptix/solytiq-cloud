...
export const SHORTCUT_DEFS: ShortcutDef[] = [
  ...
  { id: 'create-list', label: 'New list', description: 'Open the wizard to create a new list.', defaultKey: 'l', scope: 'global', scopeLabel: 'Anywhere' },
  ...
  { id: 'create-item', label: 'New item', description: 'Focus the quick-add field to add a new item.', defaultKey: 'i', scope: 'list', scopeLabel: 'Inside a list' },
