...
export const SHORTCUT_DEFS: ShortcutDef[] = [
  ...
  { id: 'create-list', label: 'New to-do', description: 'Open the wizard to create a new to-do.', defaultKey: 'l', scope: 'global', scopeLabel: 'Anywhere' },
  ...
  { id: 'create-item', label: 'New item', description: 'Focus the quick-add field to add a new item.', defaultKey: 'i', scope: 'list', scopeLabel: 'Inside a to-do' },
  { id: 'view-list', label: 'List view', description: 'Switch this to-do to List view.', defaultKey: '1', scope: 'list', scopeLabel: 'Inside a to-do' },
  { id: 'view-kanban', label: 'Kanban view', description: 'Switch this to-do to Kanban view.', defaultKey: '2', scope: 'list', scopeLabel: 'Inside a to-do' },
  { id: 'view-timeline', label: 'Timeline view', description: 'Switch this to-do to Timeline view.', defaultKey: '3', scope: 'list', scopeLabel: 'Inside a to-do' },
