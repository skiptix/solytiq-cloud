...
export const SHORTCUT_DEFS: ShortcutDef[] = [
  ...
  { id: 'toggle-empty-sections', label: 'Toggle empty sections', description: 'Show or hide sections with no tasks (Quick Add boards only).', defaultKey: 'e', scope: 'list', scopeLabel: 'Inside a board' },
