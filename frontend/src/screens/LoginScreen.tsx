...
export default function LoginScreen() {
  ...
  return (
    <div style={s.wrap}>
      <img src="/assets/solytiq-todo-logo.png" alt="Solytiq Cloud" style={{ width: 80, height: 80, borderRadius: 20, objectFit: 'cover', boxShadow: '0 4px 20px rgba(94,77,187,0.18)' }} />
